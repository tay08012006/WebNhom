<?php
// Đặt tên session cho học sinh và khởi động session
...
// Lấy ID và họ tên học sinh từ session
...
// Truy vấn lấy danh sách bài tập chưa nộp của học sinh
...
<head>
    ...
    <style>
        /* Xóa khoảng cách mặc định và dùng font chữ Nunito */
        * { 
            margin: 0; 
            padding: 0; 
        ...
        /* Nội dung chính bên phải thanh sidebar */
        .main-content {
            flex: 1;
            margin-left: 280px;
            padding: 40px;
        ...
        /* Giao diện khi thanh sidebar bị thu gọn */
        .main-content.mo-rong {
            margin-left: 80px;
        }

        /* Tiêu đề của từng khu vực (Lớp học, Bài tập) */
        .section-title { 
            font-size: 18px; 
            font-weight: 800; 
            color: #0f172a; 
        ...
        /* Lưới hiển thị danh sách lớp học */
        .class-grid { 
            display: grid; 
        ...
        /* Thẻ chứa thông tin của một lớp học */
        .class-card { 
            background: white; 
            border-radius: 14px; 
        ...
        /* Hiệu ứng nổi thẻ lên khi di chuột vào */
        .class-card:hover {
        ...
        /* Phần đầu của thẻ lớp học (Nền xanh) */
        .class-header { 
        ...
        /* Phần thân màu trắng của thẻ lớp học */
        .class-body {
            padding: 20px;
            flex-grow: 1;
            display: flex;
        ...
        /* Nhãn trạng thái "Đang học" màu xanh lá */
        .badge-status { 
        ...
        /* Khung chứa các nút hành động trong lớp */
        .action-buttons {
            display: flex;
            gap: 10px; 
            width: 100%;
        ...
        /* Khung danh sách bài tập chưa nộp */
        .homework-box { 
            background: white; 
            border-radius: 16px; 
        ...
        <div class="class-grid">
            <?php if ($result_class->num_rows > 0): ?>
                <?php while ($row = $result_class->fetch_assoc()): 
                    ...
                    // Xử lý lấy đường dẫn ảnh đại diện (avatar) của giáo viên
                    ...
                    if (!empty($gv_avatar) && !str_starts_with($gv_avatar, 'http')) {
                        ...
                        // Nếu chưa có ảnh, tự tạo ảnh có chữ cái đầu tiên của tên
