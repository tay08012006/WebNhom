...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Nunito', sans-serif; }
        ...
        /* CẤU TRÚC CONTAINER NỘI DUNG CHÍNH */
        .main-content {
            flex: 1;
            margin-left: 280px; /* Nhường chỗ cho thanh sidebar */
            padding: 40px;
            padding-top: 100px; /* Tránh đè nút 3 gạch */
            box-sizing: border-box;
            transition: margin-left 0.3s ease; 
        }
        
        /* Khi bấm ẩn sidebar, nội dung mở rộng ra */
        ...
        .section-title { font-size: 18px; font-weight: 800; color: #0f172a; margin-top: 30px; margin-bottom: 20px; display: flex; align-items: center; gap: 8px; }
...
<body>
    ...
    <div class="main-content">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
            <h1 style="font-weight: 800; font-size: 28px;">Chào em, Tây!</h1>
        </div>
        ...
        <div class="class-grid">
            <?php if ($result_class->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p style="grid-column: 1/-1; color: #64748b; font-weight: 600; padding: 10px 0;">Em chưa tham gia lớp học nào cả. Hãy nhập mã để vào lớp nhé!</p>
            <?php endif; ?>
        </div>
