...
<div class="container">
    ...
    <?php if (!empty($result['nhan_xet_gv'])): ?>
        <div style="background: white; padding: 24px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); border-left: 4px solid #0277bd;">
            <div style="font-size: 14px; font-weight: 700; color: #0277bd; margin-bottom: 12px;">📝 Nhận xét của giáo viên</div>
            <div style="font-size: 14px; color: #2d3748; line-height: 1.6;"><?= nl2br(htmlspecialchars($result['nhan_xet_gv'])) ?></div>
        </div>
    <?php endif; ?>
</div>
