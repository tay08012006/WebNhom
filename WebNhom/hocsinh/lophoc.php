...
// Hàm tự động tạo chữ viết tắt cho Avatar (Ví dụ: "Lập trình web" -> "LT")
...
// 3. TRUY VẤN LẤY DANH SÁCH LỚP HỌC (Giữ nguyên gốc của bạn)
...
<head>
    ...
    <style>
        * { 
        ...
        /* THIẾT KẾ THẺ MỚI BO GÓC 15PX KHÔNG TRÀN VIỀN */
        .the-lop-hoc {
            background: white;
            ...
            min-height: 200px;
            overflow: hidden; /* Đảm bảo góc màu xanh bo tròn theo thẻ */
        }
        ...
        /* KHUNG ĐẦU THẺ MÀU XANH GRADIENT GIỐNG GIÁO VIÊN */
        .card-header-blue {
        ...
        /* VÒNG TRÒN AVATAR CHỮ TRẮNG TRONG SUỐT */
        .avatar-lop {
            width: 46px;
            height: 46px;
        ...
        .the-lop-hoc h3 {
            color: white; /* Đổi thành chữ trắng để nổi bật trên nền xanh */
            font-size: 18px;
            font-weight: 800;
            margin: 0;
            line-height: 1.3;
        ...
        /* VIÊN THUỐC HIỂN THỊ MÃ LỚP ĐẸP MẮT */
        .ma-lop-badge {
            background: #e0f2fe;
            color: #0369a1;
            padding: 5px 12px;
        ...
        <?php if ($class_count > 0): ?>
            <div class="grid-lop-hoc">
                <?php while ($row = $result_class->fetch_assoc()): 
                    // Tự động cắt chữ cái làm avatar (Ví dụ: "Lập trình web" -> "LT")
