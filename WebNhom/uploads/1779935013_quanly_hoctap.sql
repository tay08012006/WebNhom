...
-- ============================================================
-- =====================================================
-- THÊM MỚI: Bảng quản lý nhóm học tập
-- =====================================================
...
CREATE TABLE `nhom_hoc` (
  ...
  KEY `id_truong_nhom` (`id_truong_nhom`),
  CONSTRAINT `nhom_hoc_ibfk_1` FOREIGN KEY (`class_id`) REFERENCES `classes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `nhom_hoc_ibfk_2` FOREIGN KEY (`id_truong_nhom`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `thanh_vien_nhom` (
  ...
  `trang_thai` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=chờ duyệt, 1=chính thức',
  `ngay_tham_gia` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `nhom_id` (`nhom_id`),
  KEY `student_id` (`student_id`),
  CONSTRAINT `tvn_ibfk_1` FOREIGN KEY (`nhom_id`) REFERENCES `nhom_hoc` (`id`) ON DELETE CASCADE,
  CONSTRAINT `tvn_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Thêm cột nhom_id vào bảng nop_bai để hỗ trợ nộp bài nhóm
ALTER TABLE `nop_bai` ADD COLUMN `nhom_id` int(11) DEFAULT NULL AFTER `student_id`;
ALTER TABLE `nop_bai` ADD KEY `nhom_id` (`nhom_id`);
ALTER TABLE `nop_bai` ADD CONSTRAINT `nop_bai_nhom_fk` FOREIGN KEY (`nhom_id`) REFERENCES `nhom_hoc` (`id`) ON DELETE SET NULL;
--
-- Cấu trúc bảng cho bảng `danh_gia`
-- (Đánh giá giáo viên ẩn danh từ học sinh)
--
