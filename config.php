...
define('SMTP_USER', 'dtan8897@gmail.com');   // ← Đổi your_email thành Gmail thật
define('SMTP_PASS', 'rbio ngsd jfnl uilc'); // ← Giữ nguyên
define('SMTP_FROM', 'dtan8897@gmail.com');   // ← Đổi your_email thành Gmail thật
