    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .teacher-badge {
            ...
            font-size: 13px; color: #2e7d32; font-weight: 700;
            margin-bottom: 16px; display: none;
            text-align: center;
        }
        .teacher-badge.show { display: block; }
    </style>
</head>
<body>
    ...
    <form action="xulydk.php" method="POST">
        ...
        <div class="input-group">
            ...
            <div class="password-wrapper">
                <input type="password" name="password" id="reg-pwd" required placeholder="Nhập mật khẩu của bạn">
        ...
        <div class="input-group">
            ...
            <div class="password-wrapper">
                <input type="password" name="confirm_password" id="reg-confirm-pwd" required placeholder="Nhập lại mật khẩu của bạn">
...
<script>
    ...
    function switchRole(role) {
        ...
        if (role === 'student') {
            ...
            subjectInput.placeholder = 'Nhập môn học yêu thích của bạn';
            teacherBadge.classList.remove('show');
        } else {
            ...
            subjectInput.placeholder = 'Nhập chuyên môn giảng dạy của bạn';
