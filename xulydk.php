...
//  XULYDK.PHP — Xử lý đăng ký tài khoản
//  Luồng: Validate → Lưu DB → Tạo OTP → Gửi email → Chuyển xác minh
...
//  Tạo OTP xác minh đăng ký (6 chữ số, hiệu lực 5 phút)

$otp = str_pad(random_int(0, 999999), 6, '0', STR_PAD_LEFT);

// Xoá OTP cũ (nếu có) rồi lưu mới
...
//  Lưu thông tin OTP vào session để xacnhan_otp.php xử lý
