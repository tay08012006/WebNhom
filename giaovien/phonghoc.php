...
<body>
    ...
    <div class="container">
        <div class="class-banner">
            <div style="display: flex; align-items: center; gap: 14px;">
                ...
                <div>
                    ...
                    <p><?= htmlspecialchars($current_class['hoc_ky'] ?? 'Chưa cập nhật học kỳ') ?> | Mã lớp: <b><?= htmlspecialchars($current_class['ma_lop']) ?></b></p>
                </div>
            </div>
        </div>
      ...
      <div class="class-nav">
           ...
           <a href="dangvideo.php?malop=<?= $ma_lop ?>" style="color: #f4f4ed; display: flex; align-items: center; gap: 5px; text-decoration: none; font-weight: 750;">
        ...
        <div class="content">
            ...
            if ($tab === 'bang-tin') {
                ...
                include 'taobaitap.php'; // Toàn bộ phần tạo & danh sách trắc nghiệm đã được gộp gọn vào đây
