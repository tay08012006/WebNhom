                    ...
                    <div class="bl-section">
                        ...
                        <?php if ($bl_count > 0): ?>
                            ...
                            <div class="bl-item">
                                ...
                                <div class="bl-bubble" <?= $is_teacher ? 'style="background:#eff6ff;border-left:3px solid #1e40af;"' : 'style="background:#f0fdf4;border-left:3px solid #15803d;"' ?>>
                                    <div class="bl-name">
                        ...
                        <!-- Form GV bình luận -->
                        <form action="<?= htmlspecialchars(dirname($_SERVER['PHP_SELF'])) ?>/xulybinhluan_gv.php" method="POST" class="bl-form">
