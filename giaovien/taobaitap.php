    ...
    ?>
            <div class="bt-card" id="quiz-<?= $qz['id'] ?>" style="border-left: 4px solid #28a745;">
                ...
                <div class="dropdown-container">
                    <button class="quiz-dropdown-btn" onclick="toggleQuizDropdown(event, 'quizMenuBT_<?= $qz['id'] ?>')">
                        ⋮
                    </button>
                    <div id="quizMenuBT_<?= $qz['id'] ?>" class="quiz-dropdown-content">
                        <a href="tracnghiem/xem_tracnghiem.php?quiz_id=<?= $qz['id'] ?>&malop=<?= urlencode($ma_lop) ?>">
                            👁 Xem chi tiết
                        </a>
                        <a href="tracnghiem/danhsach_thi.php?quiz_id=<?= $qz['id'] ?>&malop=<?= urlencode($ma_lop) ?>">
                            📋 Xem danh sách thi
                        </a>
                        <a href="tracnghiem/xoa_tracnghiem.php?quiz_id=<?= $qz['id'] ?>&malop=<?= urlencode($ma_lop) ?>" 
                           class="delete-btn" 
