            ...
            <?php while ($quiz = $quizzes->fetch_assoc()): ?>
                <div class="quiz-item">
                    ...
                    <div class="dropdown-container">
                        <button class="quiz-dropdown-btn" onclick="toggleQuizDropdown(event, 'quizMenu_<?= $quiz['id'] ?>')">
                            ⋮
                        </button>
                        <div id="quizMenu_<?= $quiz['id'] ?>" class="quiz-dropdown-content">
