...
<div class="login-wrapper">
    ...
    <?php if (isset($_GET['error'])): ?>
        <div style="color: #d32f2f; background-color: #ffebee; border: 1px solid #ffcdd2; padding: 12px; border-radius: 8px; text-align: center; margin-bottom: 20px; font-weight: 700; font-size: 14px; box-shadow: 0 2px 4px rgba(211, 47, 47, 0.1);">
            <?= htmlspecialchars($_GET['error']) ?>
        </div>
    <?php endif; ?>
    <?php if (isset($_GET['success'])): ?>
        <div style="color: #2e7d32; background-color: #e8f5e9; border: 1px solid #c8e6c9; padding: 12px; border-radius: 8px; text-align: center; margin-bottom: 20px; font-weight: 700; font-size: 14px;">
    ...
    <form action="xulidn.php" method="POST">
        ...
        <div class="input-group">
            ...
            <div class="password-wrapper">
                <input type="password" name="password" id="login-pwd" required placeholder="********">
                <span class="toggle-password" onclick="togglePassword('login-pwd', this)" title="Hiển thị mật khẩu">
    ...
    <div style="text-align: center; margin-top: 15px; margin-bottom: 10px; font-size: 14px;">
        Chưa có tài khoản? <a href="trangdangky.php" style="color: #0288d1; text-decoration: none; font-weight: bold;">Đăng ký ngay</a>
    </div>
    
    <div class="footer-links">
    Quên mật khẩu? <a href="quenmatkhau.php" style="color: #0288d1; text-decoration: none; font-weight: bold;">Nhấn vào đây</a>
</div>
</div>
